<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="AiXi.WebSite.Register" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    <script>
        ...
        captcha.on('click', function () {
            ...
            //给每一次点击时随机添加一个url参数，让每次请求的参数不一样
            $$(this).attr('src', captchaSrc + "?r=" + Math.random());
        })
    </script>
</asp:Content>
